...
## User-Guide
Before compiling the program, ensure that you have installed [PETSc](https://petsc.org/release/install/download/) (for solving the linear system), [METIS](https://github.com/KarypisLab/METIS) and [fMETIS](https://github.com/ivan-pi/fmetis) (for mesh agglomeration) and [MPI](https://www.open-mpi.org/software/ompi/v4.1/) (for message passing) on your computer.
